...
func TestCfdAddMultisigSignConfidentialTxWitness(t *testing.T) {
	...
	err = CfdGoFreeHandle(handle)
	assert.NoError(t, err)
	fmt.Print("TestCfdAddMultisigSignConfidentialTxWitness test done.\n")
}

func TestCfdAddMultisigSignConfidentialTxWitnessSeparate(t *testing.T) {
	handle, err := CfdGoCreateHandle()
	assert.NoError(t, err)
	...
	// sign multisig
	// txHex, err := CfdGoAddConfidentialTxUnlockingScript(handle, kTxData, txid, vout, true, "00", true)
	txHex, err := CfdGoAddConfidentialTxSign(handle, kTxData, txid, vout, true, "00", true)
	...
	if err == nil {
		...
		txHex, err = CfdGoAddConfidentialTxDerSign(handle, txHex, txid, vout, true, signature2, sigHashType, false, false)
		// txHex, err := CfdGoAddConfidentialTxUnlockingScript(handle, txHex, txid, vout, true, signature2, false)
		assert.NoError(t, err)
		...
		txHex, err = CfdGoAddConfidentialTxDerSign(handle, txHex, txid, vout, true, signature1, sigHashType, false, false)
		// txHex, err := CfdGoAddConfidentialTxUnlockingScript(handle, txHex, txid, vout, true, signature1, false)
		assert.NoError(t, err)

		// generate
		//txHex, err = CfdGoAddConfidentialTxUnlockingScript(handle, txHex, txid, vout, true, multisigScript, false)
		txHex, err = CfdGoAddConfidentialTxSign(handle, txHex, txid, vout, true, multisigScript, false)
		//txHex, err := CfdGoFinalizeElementsMultisigSign(
		//	handle, multiSignHandle, kTxData, txid, vout, hashType, multisigScript, "", true)
		assert.NoError(t, err)
		assert.Equal(t, "", txHex)
	...
	err = CfdGoFreeHandle(handle)
	assert.NoError(t, err)
	fmt.Print("TestCfdAddMultisigSignConfidentialTxWitnessSeparate test done.\n")
}
